...
app.get('/resources', (req,res) =>{
	res.status(200)
		.send('pubilc resource, you can view this');
})

app.get('/resources/secret', jwtCheck, (req,res) => {
	res.status(200)
		.send('secret resource, you have to login to see this');
})
app.post('/login', (req,res) => {
	if (!req.body.username || !req.body.password) {
		res.status(400)
			.send('you need a valid username and password')
		return;
